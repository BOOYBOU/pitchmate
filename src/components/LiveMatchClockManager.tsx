...
export const LiveMatchClockManager: React.FC<LiveMatchClockManagerProps> = ({ match }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-3xl bg-[#141A26] border border-[#E5B869]/30 shadow-2xl space-y-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <span className="relative flex h-3 w-3">
              ...
              <span className={`relative inline-flex rounded-full h-3 w-3 ${isRunning ? 'bg-[#E5B869]' : 'bg-slate-500'}`} />
            </span>
          ...
          <div className="flex items-center gap-3">
            <div className="px-5 py-2 rounded-2xl bg-[#080B10] border border-[#E5B869]/30 text-center font-mono">
              <span className="text-2xl sm:text-3xl font-black tracking-widest text-[#F5D794]">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-[#080B10] hover:bg-[#1a2232] border border-[#E5B869]/20 text-slate-300 hover:text-white transition-colors cursor-pointer"
              ...
              <button
                ...
                className="px-2.5 py-2 rounded-xl bg-[#080B10] hover:bg-[#1a2232] border border-[#E5B869]/20 text-[#F5D794] text-xs font-bold transition-colors cursor-pointer"
        ...
        {/* Big Live Scoreboard */}
        <div className="grid grid-cols-3 items-center p-5 rounded-2xl bg-[#080B10] border border-[#E5B869]/20">
          {/* Green Team */}
          <div className="text-center space-y-1">
            <div className="inline-block px-3 py-1 rounded-full bg-[#0D503C]/40 text-[#4EBA86] border border-[#0D503C] text-xs font-black">
              🟢 {t('matches.greenTeam')}
            </div>
            ...
            <div className="flex items-center justify-center gap-1">
              <button
                ...
                className="w-6 h-6 rounded-lg bg-[#141A26] hover:bg-[#1e2738] border border-[#E5B869]/20 text-slate-300 font-bold text-xs cursor-pointer"
              >
                -
              </button>
              <button
                onClick={() => updateMatchScore(match.id, scoreGreen + 1, scoreBlue)}
                className="w-6 h-6 rounded-lg bg-[#0D503C] hover:bg-[#13684F] text-white font-bold text-xs cursor-pointer"
              >
                +
              </button>
            </div>
          ...
          {/* VS Divider */}
          <div className="text-center text-[#E5B869] font-bold text-sm uppercase tracking-widest font-display">
            {language === 'ar' ? 'ضد' : 'VS'}
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* 1. Log Goal */}
        <form onSubmit={handleAddGoal} className="p-4 rounded-2xl bg-[#080B10] border border-[#E5B869]/20 space-y-3">
          <div className="flex items-center gap-2 text-xs font-bold text-white">
            <Flame className="w-4 h-4 text-[#E5B869]" />
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <button
              ...
              className={`py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                goalTeam === 'green' ? 'bg-[#0D503C] text-white border border-[#4EBA86]/40' : 'bg-[#141A26] text-slate-400 border border-[#E5B869]/10'
              }`}
            >
              🟢 {t('matches.greenTeam')}
            </button>
            <button
              ...
              className={`py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                goalTeam === 'blue' ? 'bg-blue-600 text-white' : 'bg-[#141A26] text-slate-400 border border-[#E5B869]/10'
              }`}
            >
              🔵 {t('matches.blueTeam')}
            </button>
          ...
          <select
            ...
            required
            className="w-full px-2.5 py-2 bg-[#141A26] border border-[#E5B869]/20 rounded-xl text-xs text-white focus:outline-none focus:border-[#E5B869]"
          >
          ...
          <button
            ...
            className="w-full py-2 bg-gradient-to-r from-[#F5D794] via-[#E5B869] to-[#C69238] hover:opacity-90 disabled:opacity-50 text-slate-950 font-black text-xs rounded-xl transition-all flex items-center justify-center gap-1 cursor-pointer"
          >
        ...
        <form onSubmit={handleAddSubstitution} className="p-4 rounded-2xl bg-[#080B10] border border-[#E5B869]/20 space-y-3">
          <div className="flex items-center gap-2 text-xs font-bold text-white">
            <ArrowRightLeft className="w-4 h-4 text-[#F5D794]" />
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <button
              ...
              className={`py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                subTeam === 'green' ? 'bg-[#0D503C] text-white border border-[#4EBA86]/40' : 'bg-[#141A26] text-slate-400 border border-[#E5B869]/10'
              }`}
            >
            ...
            <button
              ...
              className={`py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                subTeam === 'blue' ? 'bg-blue-600 text-white' : 'bg-[#141A26] text-slate-400 border border-[#E5B869]/10'
              }`}
            >
          ...
          <select
            ...
            required
            className="w-full px-2.5 py-2 bg-[#141A26] border border-[#E5B869]/20 rounded-xl text-xs text-rose-300 focus:outline-none focus:border-rose-500"
          >
          ...
          <select
            ...
            required
            className="w-full px-2.5 py-2 bg-[#141A26] border border-[#E5B869]/20 rounded-xl text-xs text-[#F5D794] focus:outline-none focus:border-[#E5B869]"
          >
          ...
          <button
            ...
            className="w-full py-2 bg-gradient-to-r from-[#F5D794] via-[#E5B869] to-[#C69238] hover:opacity-90 disabled:opacity-50 text-slate-950 font-bold text-xs rounded-xl transition-all flex items-center justify-center gap-1 cursor-pointer"
          >
        ...
        {/* 3. Cards & Discipline */}
        <form onSubmit={handleAddCard} className="p-4 rounded-2xl bg-[#080B10] border border-[#E5B869]/20 space-y-3">
          <div className="flex items-center gap-2 text-xs font-bold text-white">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <button
              ...
              className={`py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                cardType === 'yellow' ? 'bg-amber-400 text-slate-950 font-black' : 'bg-[#141A26] text-slate-400 border border-[#E5B869]/10'
              }`}
            >
            ...
            <button
              ...
              className={`py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer ${
                cardType === 'red' ? 'bg-rose-600 text-white font-black' : 'bg-[#141A26] text-slate-400 border border-[#E5B869]/10'
              }`}
            >
          ...
          <button
            ...
            className="w-full py-2 bg-[#141A26] hover:bg-[#1e2738] border border-[#E5B869]/30 disabled:opacity-50 text-white font-bold text-xs rounded-xl transition-all flex items-center justify-center gap-1 cursor-pointer"
          >
      ...
      <div className="p-5 rounded-2xl bg-[#080B10] border border-[#E5B869]/20 space-y-3">
        <h3 className="text-xs font-bold uppercase tracking-wider text-[#F5D794] flex items-center gap-2">
        ...
        <div className="space-y-2 max-h-48 overflow-y-auto">
          ...
          {/* Goals */}
          {match.goals?.map((g, i) => (
            <div key={`g_${i}`} className="flex items-center justify-between p-2.5 rounded-xl bg-[#241A0B] border border-[#E5B869]/30 text-xs">
              <div className="flex items-center gap-2">
                <span className="font-mono font-bold text-[#F5D794]">{g.minute ?? 45}'</span>
                <Flame className="w-3.5 h-3.5 text-[#E5B869]" />
              ...
              <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${g.team === 'green' ? 'bg-[#0D503C] text-[#4EBA86]' : 'bg-blue-500/20 text-blue-300'}`}>
          ...
          {match.substitutions?.map((s) => (
            <div key={s.id} className="flex items-center justify-between p-2.5 rounded-xl bg-[#141A26] border border-[#E5B869]/20 text-xs">
              <div className="flex items-center gap-2">
                <span className="font-mono font-bold text-[#F5D794]">{s.minute}'</span>
                <ArrowRightLeft className="w-3.5 h-3.5 text-[#E5B869]" />
                <span className="text-slate-300">
                  <strong className="text-[#F5D794]">{language === 'ar' ? 'دخول:' : 'IN:'}</strong> {s.playerInName} ↔ <strong className="text-rose-400">{language === 'ar' ? 'خروج:' : 'OUT:'}</strong> {s.playerOutName}
                </span>
              </div>
          ...
          {match.cardEvents?.map((c) => (
            <div key={c.id} className="flex items-center justify-between p-2.5 rounded-xl bg-[#141A26] border border-[#E5B869]/20 text-xs">
              <div className="flex items-center gap-2">
