...
export const INITIAL_USERS: UserProfile[] = [
  ...
  },
  {
    ...
    goalsCount: 16,
    badges: [
      { id: 'b1', key: 'reliable', title: 'Reliable Player', description: '98% attendance rate', icon: '🛡️', unlockedAt: '2026-01-10' },
    ],
    createdAt: new Date(Date.now() - 90 * 86400000).toISOString(),
    approvedAt: new Date(Date.now() - 90 * 86400000).toISOString(),
  },
  {
    ...
    goalsCount: 12,
    badges: [
      { id: 'b1', key: 'reliable', title: 'Reliable Player', description: '97% attendance rate', icon: '🛡️', unlockedAt: '2026-01-10' },
    ],
    createdAt: new Date(Date.now() - 90 * 86400000).toISOString(),
    approvedAt: new Date(Date.now() - 90 * 86400000).toISOString(),
  },
